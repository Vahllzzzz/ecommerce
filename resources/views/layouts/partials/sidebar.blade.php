...
@stack('styles')
    ...
    <div class="sidebar-header position-relative">
        <div class="d-flex justify-content-between align-items-center">
            <div class="logo">
                <a href="{{ route('home') }}"><img src="./assets/compiled/svg/logo.svg" alt="Logo" srcset=""></a>
            </div>
    ...
    <div class="sidebar-menu">
        <ul class="menu">
            ...
            <li
                class="sidebar-item  has-sub {{ request()->routeIs('admin.categories.*') ? 'active' : '' }}">
                ...
                <ul class="submenu ">
                    ...
                    <li class="submenu-item {{ request()->routeIs('admin.categories.index') ? 'active' : '' }}">
                        <a href="{{ route('admin.categories.index') }}" class="submenu-link">Kategori</a>
                    </li>>
                </ul>
            </li>
            <li
                class="sidebar-item  has-sub {{ request()->routeIs('admin.products.*') ? 'active' : '' }}">
                <a href="" class='sidebar-link'>
                    <i class="bi bi-stack"></i>
                    <span>Produk</span>
                </a>
    ...
    <div class="sidebar-menu">
        <ul class="menu">
            ...
            <li class="sidebar-item has-sub">
                <a href="{{ request()->routeIs('admin/dashboard') ? 'active' : '' }}" class="sidebar-link">
                    <i class="bi bi-stack"></i>
                    <span>Kategori</span>
                </a>
...
<div class="ps__rail-x" style="left: 0px; bottom: 0px;"><div class="ps__thumb-x" tabindex="0" style="left: 0px; width: 0px;"></div></div><div class="ps__rail-y" style="top: 0px; height: 632px; right: 0px;"><div class="ps__thumb-y" tabindex="0" style="top: 0px; height: 226px;"></div></div></div>
        </div> --}}